...
class NewMujarradSarfSagheerListingAdapter :
    RecyclerView.Adapter<NewMujarradSarfSagheerListingAdapter.ViewHolder> {
...
//        final String[] array = (String[]) sarfSagheer.get(position).toArray.get();
        ...
        if (length == 12) {
            ...
            holder.ismala.text = toArray[10] as CharSequence
            holder.ismzarf.text = toArray[11] as CharSequence
