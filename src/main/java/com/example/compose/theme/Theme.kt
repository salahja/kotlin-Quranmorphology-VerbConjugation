...
import com.codelab.basics.ui.theme.md_db__theme_dark_background
import com.codelab.basics.ui.theme.md_db__theme_dark_error
import com.codelab.basics.ui.theme.md_db__theme_dark_errorContainer
import com.codelab.basics.ui.theme.md_db__theme_dark_inverseOnSurface
import com.codelab.basics.ui.theme.md_db__theme_dark_inversePrimary
import com.codelab.basics.ui.theme.md_db__theme_dark_inverseSurface
import com.codelab.basics.ui.theme.md_db__theme_dark_onBackground
import com.codelab.basics.ui.theme.md_db__theme_dark_onError
import com.codelab.basics.ui.theme.md_db__theme_dark_onErrorContainer
import com.codelab.basics.ui.theme.md_db__theme_dark_onSecondaryContainer
import com.codelab.basics.ui.theme.md_db__theme_dark_onSurface
import com.codelab.basics.ui.theme.md_db__theme_dark_onSurfaceVariant
import com.codelab.basics.ui.theme.md_db__theme_dark_onTertiary
import com.codelab.basics.ui.theme.md_db__theme_dark_onTertiaryContainer
import com.codelab.basics.ui.theme.md_db__theme_dark_outline
import com.codelab.basics.ui.theme.md_db__theme_dark_primary
import com.codelab.basics.ui.theme.md_db__theme_dark_primaryContainer
import com.codelab.basics.ui.theme.md_db__theme_dark_scrim
import com.codelab.basics.ui.theme.md_db__theme_dark_secondary
import com.codelab.basics.ui.theme.md_db__theme_dark_secondaryContainer
import com.codelab.basics.ui.theme.md_db__theme_dark_surface
import com.codelab.basics.ui.theme.md_db__theme_dark_surfaceTint
import com.codelab.basics.ui.theme.md_db__theme_dark_surfaceVariant
import com.codelab.basics.ui.theme.md_db__theme_dark_tertiaryContainer
...
private val DarkColorsBlue = darkColorScheme(
    primary = md_db__theme_dark_primary,
    onPrimary = md_theme_dark_onPrimary,
    primaryContainer = md_db__theme_dark_primaryContainer,
    onPrimaryContainer = md_theme_dark_onPrimaryContainer,
    secondary = md_db__theme_dark_secondary,
    onSecondary = md_theme_dark_onSecondary,
    secondaryContainer = md_db__theme_dark_secondaryContainer,
    onSecondaryContainer = md_db__theme_dark_onSecondaryContainer,
    tertiary = md_theme_dark_tertiary,
    onTertiary = md_db__theme_dark_onTertiary,
    tertiaryContainer = md_db__theme_dark_tertiaryContainer,
    onTertiaryContainer = md_db__theme_dark_onTertiaryContainer,
    error = md_db__theme_dark_error,
    errorContainer = md_db__theme_dark_errorContainer,
    onError = md_db__theme_dark_onError,
    onErrorContainer = md_db__theme_dark_onErrorContainer,
    background = md_db__theme_dark_background,
    onBackground = md_db__theme_dark_onBackground,
    surface = md_db__theme_dark_surface,
    onSurface = md_db__theme_dark_onSurface,
    surfaceVariant = md_db__theme_dark_surfaceVariant,
    onSurfaceVariant = md_db__theme_dark_onSurfaceVariant,
    outline = md_db__theme_dark_outline,
    inverseOnSurface = md_db__theme_dark_inverseOnSurface,
    inverseSurface = md_db__theme_dark_inverseSurface,
    inversePrimary = md_db__theme_dark_inversePrimary,
    surfaceTint = md_db__theme_dark_surfaceTint,
    outlineVariant = md_theme_dark_outlineVariant,
    scrim = md_db__theme_dark_scrim,
